  ...
  return (
    <div className="text-gray-150 p-10 flex-grow">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 my-5 gap-10 justify-center">
        <SmallCard dayTitle="明天" img="Shower" max={20} min={12} temp="C" />
        <SmallCard
          dayTitle="Sun, 7 Jun"
          img="Clear"
          max={27}
      ...
      <div className="my-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 justify-center">
          <LargeCard title="風力狀態" num={7} desc="mph">
          ...
          <LargeCard title="濕度" num={84} desc="%">
          ...
          <LargeCard title="能見度" num={6.4} desc=" miles" />

          <LargeCard title="空氣品質" num={998} desc=" mb" />
        </div>
      </div>
    </div>
  );
